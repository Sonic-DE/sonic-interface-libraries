...
Foundational libraries, components, and tools of the Sonic workspaces

## Introduction
libblaze provides the following:
- QML components that can be used by any Sonic shell
- A C++ library: `sonic-libworkspace` itself
- Script engines

## QML components
### org.kde.plasma.core

Bindings for sonic-libworkspace functionality, such FrameSvg, see @ref core.

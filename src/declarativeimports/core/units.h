...
class Units : public QObject
{
    ...
    /**
     * units.instantaneousDuration should be used for elements that should animate near instantly,
     * but should have a hint of smoothness
     */
    Q_PROPERTY(int instantaneousDuration READ instantaneousDuration NOTIFY durationChanged)
...
/// @cond INTERNAL_DOCS
     ...
     * @since 5.75
     */
    int instantaneousDuration() const;
/// @endcond

...
QtControls.TextField {
    ...
    Row {
        ...
        PlasmaCore.IconItem {
            ...
            height: Math.max(PlasmaCore.Units.roundToIconSize(textField.height * 0.5), PlasmaCore.Units.iconSizes.small)
            width: height
        ...
        PlasmaCore.IconItem {
            ...
            height: Math.min(PlasmaCore.Units.roundToIconSize(textField.height * 0.5), PlasmaCore.Units.iconSizes.small)
            width: height

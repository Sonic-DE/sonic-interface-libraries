...
T.BusyIndicator {
    ...
    contentItem: Item {
         ...
         */
        implicitWidth: busyIndicatorSvgItem.implicitWidth
        implicitHeight: busyIndicatorSvgItem.implicitHeight
        ...
        PlasmaCore.SvgItem {
             ...
             */
            implicitWidth: Math.max(Math.min(control.width, control.height),

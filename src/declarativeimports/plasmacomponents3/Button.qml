...
T.Button {
    ...
    contentItem: GridLayout {
        ...
        PlasmaCore.IconItem {
            ...
            status: !control.flat && buttonSvg.hasElement("hint-focus-highlighted-background") && background.keyboardFocus && !control.pressed && !control.checked ? PlasmaCore.Svg.Selected : PlasmaCore.Svg.Normal
        }
        Label {
            id: label
            Layout.fillWidth: true
            ...
            color: buttonSvg.hasElement("hint-focus-highlighted-background") && background.keyboardFocus && !control.down ? PlasmaCore.Theme.highlightedTextColor : PlasmaCore.Theme.buttonTextColor

...
T.Slider {
    ...
    background: PlasmaCore.FrameSvgItem {
        ...
        Loader {
            ...
            width: control.horizontal ? parent.width - control.handle.width : undefined
            height: control.vertical ? parent.height - control.handle.height : undefined
            sourceComponent: Grid {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        implicitWidth: control.vertical ? control.background.x - PlasmaCore.Units.devicePixelRatio : PlasmaCore.Units.devicePixelRatio
                        implicitHeight: control.horizontal ? control.background.y - PlasmaCore.Units.devicePixelRatio : PlasmaCore.Units.devicePixelRatio

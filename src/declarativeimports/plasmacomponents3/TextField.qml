...
T.TextField {
    ...
    // TextField doesn't have this property for whatever reason
    readonly property bool __visualFocus: control.activeFocus && (
    ...
    placeholderTextColor: Qt.rgba(
        ...
        PlasmaCore.Theme.textColor.a * 0.5
    )
    ...
    background: PlasmaCore.FrameSvgItem {
        ...
        Private.TextFieldFocus {
            state: control.__visualFocus ? "focus" : (control.hovered ? "hover" : "hidden")
            anchors.fill: parent
        }
    }
}

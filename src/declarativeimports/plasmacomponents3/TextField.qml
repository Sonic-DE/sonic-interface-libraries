...
T.TextField {
    ...
    leftPadding: (__hasBackgroundAndMargins ? background.margins.left : 0) + (control.LayoutMirroring.enabled ? inlineButtonRow.width : 0)
    rightPadding: (__hasBackgroundAndMargins ? background.margins.right : 0) + (control.LayoutMirroring.enabled ? 0 : inlineButtonRow.width)
    ...
    Row {
        ...
        PlasmaCore.IconItem {
            ...
            source: clearButtonShown ? (control.LayoutMirroring.enabled ? "edit-clear-locationbar-ltr" : "edit-clear-locationbar-rtl") : ""
            height: PlasmaCore.Units.iconSizes.small
            width: height

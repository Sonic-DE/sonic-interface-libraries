...
QMenuProxy::QMenuProxy(QObject *parent)
    ...
    , m_requestSeamlessEdgeForPlacement(false)
{
...
bool QMenuProxy::requestSeamlessEdgeForPlacement() const
{
    return m_requestSeamlessEdgeForPlacement;
}

void QMenuProxy::setRequestSeamlessEdgeForPlacement(bool request)
{
    if (m_requestSeamlessEdgeForPlacement != request) {
        m_requestSeamlessEdgeForPlacement = request;

        Q_EMIT requestSeamlessEdgeForPlacementChanged();
    }
}
...
{
    if (m_requestSeamlessEdgeForPlacement && placement.has_value()) {

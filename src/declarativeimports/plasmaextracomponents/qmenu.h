...
class QMenuProxy : public QObject
{
     ...
     * policy.
     */
    Q_PROPERTY(bool requestSeamlessEdgeForPlacement READ requestSeamlessEdgeForPlacement WRITE setRequestSeamlessEdgeForPlacement NOTIFY
                   requestSeamlessEdgeForPlacementChanged)
...
public:
    ...
    bool requestSeamlessEdgeForPlacement() const;
    void setRequestSeamlessEdgeForPlacement(bool request);
...
Q_SIGNALS:
    ...
    void requestSeamlessEdgeForPlacementChanged();
...
private:
    ...
    bool m_requestSeamlessEdgeForPlacement;
};

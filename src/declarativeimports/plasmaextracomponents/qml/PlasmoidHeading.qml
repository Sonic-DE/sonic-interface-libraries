...
import QtQuick.Templates 2.12 as T
 ...
 T.Frame {
    ...
    bottomPadding: !headingSvg.insideRepresentationComponent && location == PlasmoidHeading.Location.Footer ? 0 : headingSvg.fixedMargins.bottom
    topPadding: headingSvg.insideRepresentationComponent || location == PlasmoidHeading.Location.Footer ? headingSvg.fixedMargins.bottom : 0
    leftPadding: headingSvg.insideRepresentationComponent ? headingSvg.fixedMargins.left : 0
    rightPadding: headingSvg.insideRepresentationComponent ? headingSvg.fixedMargins.right : 0

    implicitHeight: Math.max(implicitBackgroundHeight + topInset + bottomInset, implicitContentHeight + topPadding + bottomPadding)
    implicitWidth: Math.max(implicitBackgroundWidth + leftInset + rightInset, implicitContentWidth + leftPadding + rightPadding)

    leftInset: headingSvg.insideRepresentationComponent ? 0 : -headingSvg.fixedMargins.left
    rightInset: headingSvg.insideRepresentationComponent ? 0 : -headingSvg.fixedMargins.right
    topInset: headingSvg.insideRepresentationComponent || location == PlasmoidHeading.Location.Footer ? 0 : -headingSvg.fixedMargins.top
    bottomInset: !headingSvg.insideRepresentationComponent && location == PlasmoidHeading.Location.Footer ? -headingSvg.fixedMargins.bottom : 0

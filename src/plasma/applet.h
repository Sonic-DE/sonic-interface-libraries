...
class PLASMA_EXPORT Applet : public QObject
{
     ...
     */
    Q_PROPERTY(Applet::ConstraintHint constraintHints READ constraintHints WRITE setConstraintHints NOTIFY constraintHintsChanged FINAL)
...
public:
    ...
    Q_DECLARE_FLAGS(ConstraintFlags, ConstraintHint)
     ...
     */
    void setConstraintHints(ConstraintHint constraintHints);

    /**
     * @return The constraint hints such as CanFillArea or MarginAreasSeparator,
     *         they can be in bitwise OR
     */
    ConstraintHint constraintHints() const;
...
Q_SIGNALS:
     ...
     */
    void constraintHintsChanged(ConstraintHint constraintHints);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Applet::ConstraintFlags)

...
void FrameSvgPrivate::updateSizes(FrameData *frame) const
{
    ...
    if (auto topMargin = q->elementSize(createName(u"hint-top-margin")); topMargin.isValid()) {
    ...
    if (auto topInset = q->elementSize(createName(u"hint-top-inset")); topInset.isValid()) {
    ...
    if (auto leftMargin = q->elementSize(createName(u"hint-left-margin")); leftMargin.isValid()) {
    ...
    if (auto leftInset = q->elementSize(createName(u"hint-left-inset")); leftInset.isValid()) {
    ...
    if (auto rightMargin = q->elementSize(createName(u"hint-right-margin")); rightMargin.isValid()) {
    ...
    if (auto rightInset = q->elementSize(createName(u"hint-right-inset")); rightInset.isValid()) {
    ...
    if (auto bottomMargin = q->elementSize(createName(u"hint-bottom-margin")); bottomMargin.isValid()) {
    ...
    if (auto bottomInset = q->elementSize(createName(u"hint-bottom-inset")); bottomInset.isValid()) {

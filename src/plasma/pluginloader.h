...
public:
     ...
     * by the application
     * @deprecated Since 5.85, method is obsolete with the deprecation of the virtual methods
     **/
    PLASMA_DEPRECATED_VERSION(5, 85, "Method is obsolete with the deprecation of the virtual methods")
...
protected:
     ...
     * @param args to send the applet extra arguments
     * @return a pointer to the loaded applet, or 0 on load failure
     * @deprecated Since 5.85, deprecated for lack of usage, use default behaviour instead
     **/
    PLASMA_DEPRECATED_VERSION(5, 85, "Deprecated for lack of usage, use default behaviour instead")
     ...
     * @deprecated Since 5.85, deprecated for lack of usage, use default behaviour instead
     **/
    PLASMA_DEPRECATED_VERSION(5, 30, "Deprecated for lack of usage, use default behaviour instead")

...
public:
     ...
     * @deprecated since 5.81, use PluginLoader::listContainmentsMetaData
     * @return list of containments
     **/
    PLASMA_DEPRECATED_VERSION(5, 81, "Use PluginLoader::listContainmentsMetaData")
     ...
     * @deprecated since 5.81, use PluginLoader::listContainmentsMetaDataOfType
     * @return list of containments
     **/
    PLASMA_DEPRECATED_VERSION(5, 81, "Use PluginLoader::listContainmentsMetaDataOfType")

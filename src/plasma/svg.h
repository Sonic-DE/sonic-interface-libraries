...
public:
    ...
    QSize elementSize(const QStringView &elementId) const;
    ...
    QRectF elementRect(const QStringView &elementId) const;
    ...
    bool hasElement(const QStringView &elementId) const;

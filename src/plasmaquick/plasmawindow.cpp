    ...
    , d(new PlasmaWindowPrivate)
{
    ...
    connect(this, &QWindow::widthChanged, this, &PlasmaWindow::handleResize);
    connect(this, &QWindow::heightChanged, this, &PlasmaWindow::handleResize);

    // old code did this on show. Is that needed?
    // if so, guard updateBorders
...
void PlasmaWindow::handleResize()
{

...
void PlasmaWindow::setMainItem(QQuickItem *mainItem)
{
    ...
    if (d->mainItem) {
        ...
        connect(d->layoutChangedProxy.data(), &LayoutChangedProxy::maximumSizeChanged, this, [this]() {
            setMaximumSize(d->layoutChangedProxy->maximumSize().grownBy(margins()));
        });
        setMinimumSize(d->layoutChangedProxy->minimumSize());
        connect(d->layoutChangedProxy.data(), &LayoutChangedProxy::minimumSizeChanged, this, [this]() {
            setMinimumSize(d->layoutChangedProxy->minimumSize().grownBy(margins()));
        });
        resize(d->layoutChangedProxy->implicitSize());
        connect(d->layoutChangedProxy.data(), &LayoutChangedProxy::implicitSizeChanged, this, [this]() {

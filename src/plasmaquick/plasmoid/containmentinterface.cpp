        ...
        if ((!appletList.isEmpty() || !wallpaperList.isEmpty() || isPlasmaPackage) && !m_dropMenu->isMultipleMimetypes()) {
            ...
            if (isPlasmaPackage) {
                ...
                connect(installPlasmaPackageAction, &QAction::triggered, this, [this, packagePath]() {
                    ...
                    PackageJob *installJob = PackageJob::update(QStringLiteral("Plasma/Applet"), packagePath);
                    connect(installJob, &PackageJob::finished, this, [this, packagePath](KJob *job, const Package &package) {

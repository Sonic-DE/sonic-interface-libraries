 ...
 */
class PLASMAQUICK_EXPORT PlasmaWaylandShellIntegration : public QObject
{
    Q_OBJECT
public:
    /**
     ...
     */
    static PlasmaWaylandShellIntegration *get(QWindow *window);
    ~PlasmaWaylandShellIntegration();
...
private:
    PlasmaWaylandShellIntegration(QWindow *window);
    void surfaceCreated();

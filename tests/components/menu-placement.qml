...
ComponentBase {
    ...
    PlasmaExtras.Menu {
        ...
        requestSeamlessEdgeForPlacement: false
    ...
    footer: PC3.ToolBar {
        contentItem: RowLayout {
            ...
            PC3.CheckBox {
                ...
                text: "Request Seamless Edge"
                checked: menu.requestSeamlessEdgeForPlacement
                onToggled: menu.requestSeamlessEdgeForPlacement = checked;
            }
        }
    }
}

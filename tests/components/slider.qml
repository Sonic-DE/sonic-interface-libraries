...
ComponentBase {
    ...
    contentItem: GridLayout {
        ...
        PlasmaComponents.Slider {
            id: horizontalSlider
            /* FIXME, probably in the style:
             * Without the line of code below, the slider has no width.
             * Maybe it needs implicitWidth?
             * This is the same as the width in src/declarativeimports/plasmacomponents/Slider.qml
             */
        ...
        PlasmaComponents.Slider {
            id: verticalSlider
            // FIXME: Same as above, but for height and implicitHeight
